...
public class Numbers {
	...
	/*
	 * Show all the different kind of sorting algorithm by applying into (num
	 * array). Display the execution time for each sorting.Example in below.
	 *
	 * Use any databases[MongoDB, Oracle or MySql] to store data and retrieve data.
	 *
	 * At the end. After running all the sorting algo, come to a conclusion which
	 * one is suitable on given data set.
	 *
	 */
	// Selection sort took 335291 milli sec
	// Insertion took 331379
	// Bubble took 1308890
	// Merge took 159
	// Quick Sort 126
	// Heap took 190
	// Bucket took 182
	// Shell took 170
	// Quick sort is the best followed by merge sort, bubble sort was the worst by
	// far.
	...
	public static void main(String[] args) throws Exception {
		...
		System.out.println("Total Execution Time of " + num.length + " numbers in Merge Sort take: "
				+ mergeSortExecutionTime + " milli sec");
		...
		System.out.println("Total Execution Time of " + num.length + " numbers in Quick Sort take: "
				+ quickSortExecutionTime + " milli sec");
		...
		System.out.println("Total Execution Time of " + num.length + " numbers in Bucket Sort take: "
				+ bucketSortExecutionTime + " milli sec");
